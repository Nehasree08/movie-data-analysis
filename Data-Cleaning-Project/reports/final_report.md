...
**Dataset:** Netflix / IMDb-style catalog (`n_movies.csv`)  
...
| **Alternate** | `Data-Cleaning-Project/data/n_movies.csv` |
| File analyzed | C:\Users\Lenovo\Downloads\netfilx\n_movies.csv |
...
**Output file:** `Data-Cleaning-Project/data/cleaned_n_movies.csv` (path relative to project root).
...
- Overall: The dataset represents a modern catalog with high engagement (votes) for recent releases.
